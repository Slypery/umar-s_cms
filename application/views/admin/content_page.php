<div class="p-6 page hidden" id="content_page">
  <ol class="list-reset flex m-2  align-middle">
    <li class="text-neutral-400">Content</li>
    <li><span class="mx-1 text-neutral-300">/</span></li>
    <li class="text-neutral-200">table</li>

    <li class="ml-auto">
      <a href="<?= base_url('admin/content/add_content') ?>">
  ...
  <div data-te-datatable-init class="rounded-lg overflow-auto uhh">
    <table>
      ...
      <tbody>
        <?php
        foreach ($content_data as $i) {
          echo "<tr>";
          echo "<td>" . $i['title'] . "</td>";
          echo "<td>" . $i['view_count'] . "</td>";
          echo
          '<td>
            <a class="text-blue-700 underline hover:text-purple-500" href="'.base_url('admin/content/view_content_detail').'?content_id=' . $i['content_id'] . '">Click to see content</a>
          </td>';
          echo "<td>" . $i['category'] . "</td>";
          echo "<td>" . $i['date'] . "</td>";
          echo "<td>" . $i['creator'] . "</td>";
          echo '<td><a class="text-blue-700 underline hover:text-purple-500" target="/blank" href="'.base_url('assets/img/content/'.$i['picture']).'">'.$i['picture'].'</a></td>';
          echo
          '<td>
            <div class="flex">
              <button type="submit" name="content_id" value="' . $i['content_id'] . '" form="form_edit">
              ...
              <button onclick="delete_content(&quot;' . $i['content_id'] . '&quot;, &quot;' . $i['title'] . '&quot;, &quot;' . $i['picture'] . '&quot;)" data-te-toggle="modal" data-te-target="#staticBackdrop" data-te-ripple-init data-te-ripple-color="light">
...
<!-- Form Edit -->
<form action="<?= base_url('admin/content/edit_content') ?>" method="post" id="form_edit"></form>
<!-- /Form Edit -->

<!-- Modal Delete -->
<script>
  function delete_content(id, title, picture) {
  ...
  <div data-te-modal-dialog-ref class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
    <div class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
      ...
      <div class="flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
        ...
        <form action="<?= base_url('controlleradmin/content_page_delete_content') ?>" method="post">
