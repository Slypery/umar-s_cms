<div class="p-6 page hidden" id="user_page">
  <ol class="list-reset flex m-2  align-middle">
    ...
    <li class="text-neutral-200">add_carousel</li>
  </ol>


  <!-- <form> --><?php echo form_open_multipart('controlleradmin/carousel_page_do_add_carousel'); ?>
