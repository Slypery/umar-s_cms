<div class="w-screen h-screen flex">
    <div class="m-auto p-5 pb-7 w-[400px] rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
        <h1 class="text-3xl mb-3">Complete your info</h1>
        <form method="post" action="<?= base_url('auth/sign_up_step_4') ?>">
            <!--E-mail input-->
            ...
            <div class="relative w-full mr-2 mb-2" data-te-input-wrapper-init>
