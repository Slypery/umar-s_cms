<div class="w-screen h-screen flex">
    <div class="m-auto p-5 pb-7 w-[400px] rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
        ...
        <form method="post" action="<?= base_url('auth/sign_up_step_2') ?>">
            ...
            <p class="text-sm opacity-70 pl-1 mb-2">we requires a verified email so that incase you forget your password. you can recover it with this email.</p>
