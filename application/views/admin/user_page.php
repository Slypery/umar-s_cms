<div class="p-6 page hidden" id="user_page">
  <ol class="list-reset flex m-2  align-middle">
    <li class="text-neutral-400">User</li>
  ...
  <form action="<?= base_url('admin/user/edit_user') ?>" method="post" id="edit"></form>
  <div data-te-datatable-init class="rounded-lg overflow-auto uhh">
    <table>
      ...
      <tbody>
        <?php
        foreach ($user_table as $i) {
          echo "<tr>";
          echo "<td>" . $i['username'] . "</td>";
          echo "<td>" . $i['name'] . "</td>";
          echo "<td>" . $i['email'] . "</td>";
          echo "<td>" . $i['level'] . "</td>";
          echo "<td>" . $i['recent_login'] . "</td>";
          echo
          '<td>
            <div class="flex">
              <button type="submit" name="user_id" value="' . $i['user_id'] . '" form="edit">
              ...
              <button onclick="delete_user(&quot;' . $i['username'] . '&quot;, &quot;' . $i['user_id'] . '&quot;)" data-te-toggle="modal" data-te-target="#staticBackdrop" data-te-ripple-init data-te-ripple-color="light">
...
<!-- Modal -->
<!-- <button data-te-toggle="modal" data-te-target="#staticBackdrop" data-te-ripple-init data-te-ripple-color="light">triger</button> -->

<script>
  function delete_user(username, id) {
    document.getElementById('delete_modal_body').innerHTML = "username = " + username;
  ...
  <div data-te-modal-dialog-ref class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
    <div class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
      ...
      <div class="flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
        ...
        <form action="<?= base_url('controlleradmin/user_page_delete_user') ?>" method="post">
