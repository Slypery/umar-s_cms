...
<div class="w-screen h-screen flex">
    <div class="m-auto p-5 pb-7 w-[400px] rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
        ...
        <form method="post" action="<?= base_url('auth/forgot_password_step_3') ?>" id="verf"></form>
        <!--E-mail input-->
        <?php
        if (!empty($forgot_password_data['wrong_code'])) {
            echo 
        ...
        ?>
        <p>Please enter the 6 digit code we've send to your email</p>
...
<div class="hidden" id="cooldown"><?= $forgot_password_data['cooldown'] ?></div>
