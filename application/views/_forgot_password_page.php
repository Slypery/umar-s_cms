<div class="w-screen h-screen flex">
    <div class="m-auto p-5 pb-7 w-[400px] rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
        <h1 class="text-3xl mb-3">Enter your username or email</h1>
        <form method="post" action="<?= base_url('auth/forgot_password_step_2') ?>">
            <!--E-mail input-->
            ...
            <p class="text-sm opacity-70 pl-1 mb-2">we will send verification code to your email for password reset</p>
